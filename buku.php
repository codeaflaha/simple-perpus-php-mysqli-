<?php
	...
	if(isset($_GET['aksi']) == 'delete'){
				$id = $_GET['id'];
				$cek = mysqli_query($db, "SELECT * FROM buku WHERE id_buku ='$id'");
...
<div id="page-wrapper">
	<div class="row">
                ...
                <a href="tambahbuku.php"><button type="button" class="btn btn-primary">Tambah Data</button></a>
                <!-- /.col-lg-12 -->
	</div>
			...
			while($tampil = mysqli_fetch_array($result,MYSQLI_ASSOC))
			{
				?>
					<tr>
						...
						<td><a href="editbuku.php?id=<?php echo $tampil['id_buku'];?>" class="btn btn-info">Edit</a></td>
						<?php echo '<td><a href="buku.php?aksi=delete&id='.$tampil['id_buku'].'" title="Hapus Data" onclick="return confirm(\'Anda yakin akan menghapus data '.$tampil['nama_buku'].'?\')" class="btn btn-danger">delete</a></td> '?>
					</tr>
